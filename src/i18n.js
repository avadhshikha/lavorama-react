...
export const translations = {
  fr: {
    ...
    // ── FOOTER ──
    footer: {
      tagline: "La laverie moderne de Genève — libre-service. Rue des Pâquis 43, 1201 Genève.",
      services: 'Services',
      links: {
    ...
    home: {
      ...
      testimonials: [
        ...
        { name: 'Anna Müller', location: 'Genève', img: 'imgi_15_p7.jpg', review: "Les machines sont excellentes et ma lessive est parfaite à chaque fois." },
      ],
  ...
  en: {
    ...
    footer: {
      tagline: "Geneva's modern self-service laundromat. Rue des Pâquis 43, 1201 Genève.",
      services: 'Services',
      links: {
